...
1. Write values to           2. Read user_data         3. Inject into
   ...
   openshift_cluster_console_url       │                          {bastion_public_hostname}
   ...                         │                          {keycloak_admin_user}
                               │                          in your AsciiDoc
----
...
# user_data (flat)
bastion_public_hostname: bastion.abc123.example.com
openshift_cluster_console_url: https://console.apps.cluster.example.com
...
openshift_cluster_console_url: https://console.apps.cluster.example.com   # global
...
asciidoc:
  attributes:
    ...
    openshift_cluster_console_url: https://console.apps.example.com
----
